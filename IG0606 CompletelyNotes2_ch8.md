...
### 6.5.2 基本形式 $\sin x = k$（$-1 \leq k \leq 1$）
...
### 6.5.3 基本形式 $\cos x = k$（$-1 \leq k \leq 1$）
...
### 6.5.4 基本形式 $\tan x = k$（$k \in \mathbb{R}$）
